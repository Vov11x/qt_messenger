...
void ServerWorker::sendJson(const QJsonObject &json)
{
    ...
    emit logMessage(QLatin1String("Sending ") + userName() + QLatin1String(" - ") + QString::fromUtf8(jsonData));
        ...
        if (socketStream.commitTransaction()) {
            ...
            if (parseError.error == QJsonParseError::NoError) {
                if (jsonDoc.isObject())
                    ...
                    emit logMessage(QLatin1String("Wrong message: ") + QString::fromUtf8(jsonData));
            } else {
                emit logMessage(QLatin1String("Wrong message: ") + QString::fromUtf8(jsonData));
            }
        } else {
